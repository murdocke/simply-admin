  ...
  return (
    <div className="space-y-8">
      <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex rounded-full border border-[var(--c-ecebe7)] bg-[var(--c-ffffff)] p-1 text-xs uppercase tracking-[0.2em] text-[var(--c-6f6c65)] shadow-sm">
          <button className="rounded-full bg-[var(--c-c8102e)] px-4 py-2 text-white">
            Learning
          </button>
          ...
          <div className="mt-4 space-y-3">
            {['Recent: How to pace Lesson 12?', 'Pending replies: 2'].map(
              item => (
                <div
                  key={item}
                  className="rounded-xl border border-[var(--c-ecebe7)] bg-[var(--c-ffffff)] px-4 py-3 text-sm text-[var(--c-3a3935)]"
                >
                  {item}
                </div>
              ),
