    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="text-sm text-[var(--c-6f6c65)] mt-2">
          Review distributions, statements, and upcoming payouts.
        </p>
      </header>

      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        {[
          { label: 'Due This Month', value: '$205,335', note: 'Projected total' },
          { label: 'Paid Out', value: '$178,420', note: 'Latest cycle' },
          { label: 'Pending Reviews', value: '12', note: 'Awaiting approval' },
        ].map(item => (
          <div
            key={item.label}
